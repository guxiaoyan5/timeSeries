...
from layers.autoformer_EncDec import Encoder, Decoder, EncoderLayer, DecoderLayer, Layernorm, SeriesDecomp, \
    SeriesDecompMulti
from layers.embed import DataEmbeddingWoPos
from layers.selfAttention import AttentionLayer
from layers.selfAttention import FourierBlock, FourierCrossAttention, MultiWaveletCross, MultiWaveletTransform
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.enc_embedding = DataEmbeddingWoPos(configs.enc_in, configs.d_model, configs.embed, configs.freq,
                                                configs.dropout)
        self.dec_embedding = DataEmbeddingWoPos(configs.dec_in, configs.d_model, configs.embed, configs.freq,
                                                configs.dropout)
